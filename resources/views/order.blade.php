            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="full_name" required placeholder="Enter your first name" name="full_name" class="form-control" id="">
                            </div>
                            <div class="form-group">
                                <label for="">Contact Phone</label>
                                <input type="text" id="billing_phone" required placeholder="Enter contact phone number" name="" class="form-control" id="">
                            </div>
                             <div class="form-group">
                                <label for="">Email Address    </label>
                                <input type="email" id="billing_email" required placeholder="Enter email address" name="" class="form-control" id="">
                            </div>
                            <div class="form-group">
                                <label for="">Address</label>
                                <input type="text" id="billing_address" placeholder="1234 Main Street." required name="" class="form-control" id="">
                            </div>
                            <div class="form-group">
                            ...
                            <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-gradient btn-block">
                                ...
                                <span id="payment-button-amount">Complete Payment #{{number_format($total + 1200,2)}}</span>
                            ...
                            <input type="hidden" name="metadata" id="meta-data" value="" > 
                                ...
                                <input type="hidden" name="amount" id="amount" value="{{($total + 1200)*100}}">
                ...
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
                            <div class="price">
                                <h4 style="padding-bottom:10px; font-weight:550; border-bottom: 1px solid #eee;">Order
                                    Summary</h4>
                                    <div class="order-charge-container" style="border-bottom: 2px solid #eee">
                                    @foreach($orders as $order)
                                    <div>
                                        <dl class="charges-totle">
                                            <dt class="float-left">{{$order['quantity']}} X {{$order['name']}}</dt>
                                            <dd class="float-right"> #{{number_format($order['price'],2)}}</dd>
                                        </dl>
                                    </div>
                                ...
                                <div class="order-charge-container" style="border-bottom: 2px solid #eee">
                                    <div>
                                        <dl class="charges-totle">
                                            ...
                                            <dd class="float-right"><b>#{{number_format($total,2)}}</b></dd>
                                        </dl>
                                    </div>
                                    <div style="clear: both"></div>
                                    <div>
                                ...
                                <div class="total-price">
                                    <dl>
                                        ...
                                        <dd class="float-right"><b>#{{number_format($total+1200,2)}}</b></dd>
                                    </dl>
                                </div>
                                <div style="clear: both"></div>
                            </div>
